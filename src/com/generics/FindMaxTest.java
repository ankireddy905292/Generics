...
public class FindMaxTest {
    ...
    public void givenFirstIntegerNumberAsLarge_ShouldReturn_FirstNumberAsMax() {
        ...
        Integer max = new FindMaxOfThree<>(integerValues).findMaxValue();
    ...
    public void givenFirstFloatNumberAsLarge_ShouldReturn_FirstNumberAsMax() {
        ...
        Float max = new FindMaxOfThree<>(floatValues).findMaxValue();
    ...
    public void givenFirstStringAsLarge_ShouldReturn_FirstStringAsMax() {
        ...
        String max = new FindMaxOfThree<>(stringValues).findMaxValue();
    ...
    public void givenListOfIntegers_ShouldReturn_MaxValue() {
        ...
        integerList.add(20);
        integerList.add(80);
        Object max = new FindMaxOfThree<>(integerList).findMax();
    ...
    public void givenListOfFloats_ShouldReturn_MaxValue() {
        ...
        floatList.add(20f);
        floatList.add(80f);
        Object max = new FindMaxOfThree<>(floatList).findMax();
    ...
    public void givenListOfStrings_ShouldReturn_MaxValue() {
        ...
        stringList.add("All");
        stringList.add("To");
        Object max = new FindMaxOfThree<>(stringList).findMax();
